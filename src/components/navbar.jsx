...
const Navbar = () => {
  return (
    <nav className="bg-black 2xl:text-3xl sticky z-50 fixed w-full">
      <div className='py-5 2xl:py-8 pr-10'>
        <p className='text-white float-right mb-4 2xl:mb-6 font-bold'>
          Phone: <span className='font-light'>(+442) 200 07</span> | Support: <span className='font-light'>placeholder@trial.com</span>
        </p>
            </div>
        <hr className="w-full bg-white" />
      <div className="container mx-auto flex flex-wrap items-center justify-between font-medium p-4 py-5 2xl:py-8">
